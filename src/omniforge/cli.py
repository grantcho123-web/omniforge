...
from omniforge.core import Attempt, GradingResult, Task, TaskSet
from omniforge.core.grader import make_grader
from omniforge.core.grader import registered_graders as list_graders
from omniforge.core.model import make_model
from omniforge.core.model import registered_models as list_models
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="omniforge")
