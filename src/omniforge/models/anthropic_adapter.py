...
Requires ``pip install omniforge[models]``. API key from ``ANTHROPIC_API_KEY``
...
from omniforge.models._pricing import estimate_usd
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError(
                "AnthropicAdapter requires the [models] extra: pip install omniforge[models]"
            ) from e
